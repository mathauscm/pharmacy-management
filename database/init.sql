-- Sistema de Gestão Farmacêutica - Estrutura do Banco de Dados
-- Foco em consulta histórica de compras (sem controle de estoque/vendas)
...
-- Tabela de Produtos (criados automaticamente via XML)
